...
<Preview withToolbar>
	<Story name="Primary">
		<PrimaryButton onClick={action('clicked')} disabled={boolean("Disabled", false)}>Hello world</PrimaryButton>
	</Story>
</Preview>
...
<Story name="Secondary">
  	<SecondaryButton onClick={action('clicked')}>Hello world</SecondaryButton>
</Story>
...
<Story name="Tertiary">
  	<TertiaryButton onClick={action('clicked')}>Hello world</TertiaryButton>
</Story>
